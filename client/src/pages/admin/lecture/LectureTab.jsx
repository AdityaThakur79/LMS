...
import { useGetLectureByIdQuery, useRemoveLectureMutation, useUpdateLectureMutation } from "@/features/api/courseApi";
...
const LectureTab = () => {
    ...
    const [edtiLecture, { data, isLoading, error, isSuccess }] = useUpdateLectureMutation();
